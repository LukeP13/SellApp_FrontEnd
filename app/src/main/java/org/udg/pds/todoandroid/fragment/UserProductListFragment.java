...
public class UserProductListFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_user_product_list, container, false);
    }
    ...
    public void onStart() {
        ...
        mRecyclerView.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), mRecyclerView, new RecyclerItemClickListener.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                NavDirections action = ProfileFragmentDirections.actionProfileFragmentToFragmentProduct();
    ...
    public void updateProductList() {
        ...
        long id=1;
        Call<List<Product>> call = mTodoService.getOnSaleProducts();

        call.enqueue(new Callback<List<Product>>() {
            @Override
            public void onResponse(Call<List<Product>> call, Response<List<Product>> response) {
                if (response.isSuccessful()) {
                    UserProductListFragment.this.showProductList(response.body());
                } else {
                    Toast.makeText(UserProductListFragment.this.getContext(), "Error reading products", Toast.LENGTH_LONG).show();
                }
            }
